...
export TRAIN_DATA_DIR='data/grpo'
export TEST_DATA_DIR='data/grpo'
...
#export EXPERIMENT_NAME=grpo-base
#export EXPERIMENT_NAME=nq-search-r1-grpo-qwen2.5-3b-em
#export BASE_MODEL='/home/rach0109_e_ntu_edu_sg/genai-proj/merged_b'
export BASE_MODEL='/home/rach0109_e_ntu_edu_sg/genai-proj/verl_checkpoints/grpo-adapter-b-v2/actor/global_step_100'
export EXPERIMENT_NAME=grpo-adapter-b-v2
